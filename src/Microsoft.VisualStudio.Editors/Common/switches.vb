...
#End If
    ...
    ''' <summary> Contains predefined switches for enabling/disabling trace output or code instrumentation. </summary>
    Friend Class Switches

#Region "------------ Resource Editor -------------"
        ''' <summary> Trace for the ResourceEditor.FileWatcher class. </summary>
        Public Shared RSEFileWatcher As New TraceSwitch(NameOf(RSEFileWatcher), "Trace the resource editor FileWatcher class.")
        ''' <summary> Tracing for the ResourceEditor.ResourceSerializationService class. </summary>
        ...
        ''' <summary> Track adding and removing resources in the resource editor. </summary>
        ...
        ''' <summary> Trace virtual mode methods in the resource editor's string table. </summary>
        ...
        ''' <summary> Trace virtual mode methods in the resource editor's listview. </summary>
        ...
        ''' <summary> Trace the delayed checking of errors in resources. </summary>
        ...
        ''' <summary> Disable high-quality options on the Graphics object when creating thumbnails in the resource editor. </summary>
...
#Region "------------- Project Designer -------------"
        ...
        ''' <summary> Trace performance issues for the project designer. </summary>
        Public Shared PDPerf As New TraceSwitch(NameOf(PDPerf), "Trace performance issues for the project designer")
        ''' <summary> Trace command routing (CmdTargetHelper, etc.) in the project designer. </summary>
        ...
        ''' <summary> Traces message routing in the project designer and its property pages. </summary>
        ...
        ''' <summary> Overrides the SKU edition value for the project designer. </summary>
        ...
        ''' <summary> Overrides the Sub-SKU edition value for the project designer. </summary>
        ...
        Public Shared PDAddVBWPFApplicationPageToAllProjects As New BooleanSwitch(NameOf(PDAddVBWPFApplicationPageToAllProjects),
            "Add the VB WPF Application property page to all projects, even non-WPF projects.  This allows for debugging this page without the new WPF flavor")
...
#If DEBUG Then
        ''' <summary> Uses String.Format if there are arguments, otherwise simply returns the string. </summary>
        ''' <param name="Message"/>
        ''' <param name="FormatArguments"/>

        Private Shared Function Format(Message As String, ParamArray FormatArguments() As Object) As String
            If FormatArguments Is Nothing OrElse FormatArguments.Length = 0 Then Return Message
            Try
...
#If DEBUG Then
        ''' <summary> Formats a Win32 message into a friendly form for debugging/tracing purposes. </summary>
        ''' <param name="msg"/>
        Private Shared Function FormatWin32Message(
            ...
            Select Case msg.Msg
                Case win.WM_KEYDOWN : MsgType = "WM_KEYDOWN"
                Case win.WM_KEYUP : MsgType = "WM_KEYUP"
                Case win.WM_SETFOCUS : MsgType = "WM_SETFOCUS"
                Case win.WM_CHAR : MsgType = "WM_CHAR"
                Case win.WM_SYSCHAR : MsgType = "WM_SYSCHAR"
...
#Region "EnumSwitch(Of T)"
        ...
        ''' <summary> A Switch which has a simple enum value (either as integer or string representation). </summary>
        Friend Class EnumSwitch(Of T)
            ...
            ''' <summary> True if the switch has a non-empty value. </summary>
            ...
            ''' <summary> Gets/sets the current value of the switch. </summary>
            ...
            ''' <summary> Interprets the new (string-based) correctly, based on the string or integer representation. </summary>
...
#End Region
        ...
        ''' <summary> Trace messages for the MSVBE_SCC flag. </summary>
        ''' <param name="Message"/>
        ''' <param name="FormatArguments"/>
        <Conditional("DEBUG")>
...
#End If
        ...
        ''' <param name="FormatArguments"/>
        <Conditional("DEBUG")>
        Public Shared Sub TracePDFocus(
                                        Level As TraceLevel,
                                        Message As String,
                             ParamArray FormatArguments() As Object
                                      )
#If DEBUG Then
...
#End If
        ...
        ''' <param name="FormatArguments"/>
        <Conditional("DEBUG")>
        Public Shared Sub TracePDProperties(
                                             Level As TraceLevel,
                                             Message As String,
                                  ParamArray FormatArguments() As Object
                                           )
...
#End If
        ...
        ''' <param name="FormatArguments"/>
        <Conditional("DEBUG")>
        Public Shared Sub TracePDExtenders(
                                            Level As TraceLevel,
                                            Message As String,
                                 ParamArray FormatArguments() As Object
                                          )
...
#End If
        ...
        ''' <param name="FormatArguments"/>
        <Conditional("DEBUG")>
        Public Shared Sub TracePDConfigs(
...
#End If
        ...
        <Conditional("DEBUG")>
        Public Shared Sub TracePDPerfBegin(
                                            Message As String,
                                 ParamArray FormatArguments() As Object
                                          )
#If DEBUG Then
...
#End If
        ...
        <Conditional("DEBUG")>
        Public Shared Sub TracePDPerfEnd(
                                          Message As String,
                               ParamArray FormatArguments() As Object
                                        )
#If DEBUG Then
...
#End If
        ...
        <Conditional("DEBUG")>
        Public Shared Sub TracePDPerf(
                                       e As Windows.Forms.LayoutEventArgs,
                                       Message As String,
                            ParamArray FormatArguments() As Object)
#If DEBUG Then
...
#End If
        ...
        ''' <param name="FormatArguments"/>
        <Conditional("DEBUG")>
        Public Shared Sub TracePDCmdTarget(
                                            TraceLevel As TraceLevel,
                                            Message As String,
                                 ParamArray FormatArguments() As Object
                                          )
...
#End If
        ...
        ''' <summary> Trace Win32 message routing. </summary>
        ''' <param name="TraceLevel"/>
        ''' <param name="Message"/>
        ''' <param name="msg"/>
        <Conditional("DEBUG")>
        Public Shared Sub TracePDMessageRouting(
                                                 TraceLevel As TraceLevel,
                                                 Message As String,
                                                 msg As Windows.Forms.Message
                                               )
#If DEBUG Then
...
#End If
        ...
        ''' <summary> Traces the access modifier combobox functionality. </summary>
        <Conditional("DEBUG")>
        Public Shared Sub TracePDAccessModifierCombobox(
                                                         traceLevel As TraceLevel,
                                                         message As String
                                                       )
#If DEBUG Then
...
#End If
        ...
        ''' <summary> Trace serialization of settings. </summary>
        ''' <param name="tracelevel"/>
        ''' <param name="message"/>
        <Conditional("DEBUG")>
        Public Overloads Shared Sub TraceSDSerializeSettings(
                                                              tracelevel As TraceLevel,
                                                              message As String
                                                            )
#If DEBUG Then
...
#End If
        ...
        <Conditional("DEBUG")>
        Public Overloads Shared Sub TracePDLinqImports(
                                                        tracelevel As TraceLevel,
                                                        formatString As String,
                                             ParamArray parameters() As Object
                                                      )
...
#End If
        ...
        ''' <summary> Trace changes to one of the monitored configuration files. </summary>
        ''' <param name="tracelevel"/>
        <Conditional("DEBUG")>
        Public Overloads Shared Sub TraceWCFConfigFileChangeWatch(
                                                                   tracelevel As TraceLevel,
                                                                   formatString As String,
                                                        ParamArray parameters() As Object
                                                                 )
...
#End If
        ...
        <Conditional("DEBUG")>
        Public Shared Sub TraceMyExtensibility(
                                                traceLevel As TraceLevel,
                                                message As String
                                              )
#If DEBUG Then

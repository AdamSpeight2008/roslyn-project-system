...
Namespace Microsoft.VisualStudio.Editors.Common
    ...
    Friend Module Utils
        ...
        Friend Class KnownPropertyPageGuids
            Friend Shared ReadOnly GuidApplicationPage_VB As New Guid(&H8998E48EUI, &HB89AUS, &H4034US, &HB6, &H6E, &H35, &H3D, &H8C, &H1F, &HDC, &H2E)
            Friend Shared ReadOnly GuidApplicationPage_VB_WPF As New Guid(&HAA1F44UI, &H2BA3US, &H4EAAUS, &HB5, &H4A, &HCE, &H18, &H0, &HE, &H6C, &H5D)
            Friend Shared ReadOnly GuidApplicationPage_CS As New Guid(&H5E9A8AC2UI, &H4F34US, &H4521US, CByte(&H85), CByte(&H8F), CByte(&H4C), CByte(&H24), CByte(&H8B), CByte(&HA3), CByte(&H15), CByte(&H32))
            Friend Shared ReadOnly GuidApplicationPage_JS As Guid = GuidApplicationPage_CS
            Friend Shared ReadOnly GuidSigningPage As New Guid(&HF8D6553FUI, &HF752US, &H4DBFUS, CByte(&HAC), CByte(&HB6), CByte(&HF2), CByte(&H91), CByte(&HB7), CByte(&H44), CByte(&HA7), CByte(&H92))
            Friend Shared ReadOnly GuidReferencesPage_VB As New Guid(&H4E43F4ABUI, &H9F03US, &H4129US, CByte(&H95), CByte(&HBF), CByte(&HB8), CByte(&HFF), CByte(&H87), CByte(&HA), CByte(&HF6), CByte(&HAB))
            Friend Shared ReadOnly GuidServicesPropPage As New Guid(&H43E38D2EUI, &H4EB8US, &H4204US, CByte(&H82), CByte(&H25), CByte(&H93), CByte(&H57), CByte(&H31), CByte(&H61), CByte(&H37), CByte(&HA4))
            Friend Shared ReadOnly GuidSecurityPage As New Guid(&HDF8F7042UI, &HBB1US, &H47D1US, CByte(&H8E), CByte(&H6D), CByte(&HDE), CByte(&HB3), CByte(&HD0), CByte(&H76), CByte(&H98), CByte(&HBD))
            Friend Shared ReadOnly GuidSecurityPage_WPF As New Guid(&HA2C8FEUI, &H3844US, &H41BEUS, CByte(&H96), CByte(&H37), CByte(&H16), CByte(&H74), CByte(&H54), CByte(&HA7), CByte(&HF1), CByte(&HA7))
            Friend Shared ReadOnly GuidPublishPage As New Guid(&HCC4014F5UI, &HB18DUS, &H439CUS, CByte(&H93), CByte(&H52), CByte(&HF9), CByte(&H9D), CByte(&H98), CByte(&H4C), CByte(&HCA), CByte(&H85))
            Friend Shared ReadOnly GuidDebugPage As New Guid(&H6185191FUI, &H1008US, &H4FB2US, CByte(&HA7), CByte(&H15), CByte(&H3A), CByte(&H4E), CByte(&H4F), CByte(&H27), CByte(&HE6), CByte(&H10))
            Friend Shared ReadOnly GuidCompilePage_VB As New Guid(&HEDA661EAUI, &HDC61US, &H4750US, CByte(&HB3), CByte(&HA5), CByte(&HF6), CByte(&HE9), CByte(&HC7), CByte(&H40), CByte(&H60), CByte(&HF5))
            Friend Shared ReadOnly GuidBuildPage_CS As New Guid(&HA54AD834UI, &H9219US, &H4AA6US, CByte(&HB5), CByte(&H89), CByte(&H60), CByte(&H7A), CByte(&HF2), CByte(&H1C), CByte(&H3E), CByte(&H26))
            Friend Shared ReadOnly GuidBuildPage_JS As New Guid(&H8ADF8DB1UI, &HA8B8US, &H4E04US, CByte(&HA6), CByte(&H16), CByte(&H2E), CByte(&HFC), CByte(&H59), CByte(&H5F), CByte(&H27), CByte(&HF4))
            Friend Shared ReadOnly GuidReferencePathsPage As New Guid(&H31911C8UI, &H6148US, &H4E25US, CByte(&HB1), CByte(&HB1), CByte(&H44), CByte(&HBC), CByte(&HA9), CByte(&HA0), CByte(&HC4), CByte(&H5C))
            Friend Shared ReadOnly GuidBuildEventsPage As New Guid(&H1E78F8DBUI, &H6C07US, &H4D61US, CByte(&HA1), CByte(&H8F), CByte(&H75), CByte(&H14), CByte(&H1), CByte(&HA), CByte(&HBD), CByte(&H56))
            Friend Shared ReadOnly GuidDatabasePage_SQL As New Guid(&H87F6ADCEUI, &H9161US, &H489FUS, CByte(&H90), CByte(&H7E), CByte(&H39), CByte(&H30), CByte(&HA6), CByte(&H42), CByte(&H96), CByte(&H9))
            Friend Shared ReadOnly GuidFxCopPage As New Guid(&H984AE51AUI, &H4B21US, &H44E7US, CByte(&H82), CByte(&H2C), CByte(&HDD), CByte(&H5E), CByte(&H4), CByte(&H68), CByte(&H93), CByte(&HEF))
            Friend Shared ReadOnly GuidDeployPage As New Guid(&H29AB1D1BUI, &H10E8US, &H4511US, CByte(&HA3), CByte(&H62), CByte(&HEF), CByte(&H15), CByte(&H71), CByte(&HB8), CByte(&H44), CByte(&H3C))
            Friend Shared ReadOnly GuidDevicesPage_VSD As New Guid(&H7B74AADFUI, &HACA4US, &H410EUS, CByte(&H8D), CByte(&H4B), CByte(&HAF), CByte(&HE1), CByte(&H19), CByte(&H83), CByte(&H5B), CByte(&H99))
            Friend Shared ReadOnly GuidDebugPage_VSD As New Guid(&HAC5FAEC7UI, &HD452US, &H4AC1US, CByte(&HBC), CByte(&H44), CByte(&H2D), CByte(&H7E), CByte(&HCE), CByte(&H6D), CByte(&HF0), CByte(&H6C))
            Friend Shared ReadOnly GuidMyExtensionsPage As New Guid(&HF24459FCUI, &HE883US, &H4A8EUS, CByte(&H9D), CByte(&HA2), CByte(&HAE), CByte(&HF6), CByte(&H84), CByte(&HF0), CByte(&HE1), CByte(&HF4))
            Friend Shared ReadOnly GuidOfficePublishPage As New Guid(&HCC7369A8UI, &HB9B0US, &H439CUS, CByte(&HB1), CByte(&H36), CByte(&HBA), CByte(&H95), CByte(&H58), CByte(&H19), CByte(&HF7), CByte(&HF8))
            Friend Shared ReadOnly GuidServicesPage As New Guid(&H43E38D2EUI, &H43B8US, &H4204US, CByte(&H82), CByte(&H25), CByte(&H93), CByte(&H57), CByte(&H31), CByte(&H61), CByte(&H37), CByte(&HA4))
            Friend Shared ReadOnly GuidWAPWebPage As New Guid(&H909D16B3UI, &HC8E8US, &H43D1US, CByte(&HA2), CByte(&HB8), CByte(&H26), CByte(&HEA), CByte(&HD), CByte(&H4B), CByte(&H6B), CByte(&H57))
        End Class

        ''' <summary> test if vs in build process BUGFIX: Dev11#45255  </summary>
        Public Function IsInBuildProgress() As Boolean
            ...
            If srpSelection IsNot Nothing Then
                ...
                If (NativeMethods.Succeeded(hr)) Then
                    ...
                    If (NativeMethods.Succeeded(hr)) Then Return (pfActive > 0)
                End If
            End If
            Return False
        End Function

        ''' <summary> Convert a variant to integer value. </summary>
        ''' <param name="obj"/>
        ''' <param name="value"/>
        ''' <return> return true if the variant is an integer type value. </return>
        Public Function TryConvertVariantToInt(
                                                obj As Object,
                                          ByRef value As Integer
                                              ) As Boolean

            If obj Is Nothing Then Return False
            If (TypeOf obj Is UInt16) OrElse (TypeOf obj Is Int16) OrElse
               (TypeOf obj Is UInt32) OrElse (TypeOf obj Is Int32) OrElse
               (TypeOf obj Is UInt64) OrElse (TypeOf obj Is Int64) OrElse
               (TypeOf obj Is Byte) OrElse (TypeOf obj Is SByte) OrElse
               (TypeOf obj Is Single) OrElse (TypeOf obj Is Double) Then
        ...
        ''' <summary> Masks the top 32 bits to get just the lower 32bit number. </summary>
        ...
        Public Function NoOverflowCInt(LongValue As Long) As Integer
            If LongValue <= UInt32.MaxValue Then Return CInt(LongValue)
        ...
        Public Function GetImageFromImageService(imageMoniker As ImageMoniker, width As Integer, height As Integer, background As Color) As Image
            ...
            If (ImageService Is Nothing) Then Return Nothing
            Dim attributes As New Imaging.Interop.ImageAttributes With {.StructSize = Marshal.SizeOf(GetType(Imaging.Interop.ImageAttributes)),
            ...
            If (uIOjb IsNot Nothing) Then Return CType(GelUtilities.GetObjectData(uIOjb), Bitmap)
            Return Nothing
        End Function
        ...
        ''' </summary>
        ''' <param name="ex"/>
        Public Function DebugMessageFromException(
                                                   ex As Exception
                                                 ) As String
#If DEBUG Then
            Dim ErrorMessage As String = ex.Message & vbCrLf & vbCrLf & vbCrLf & "[SHOWN IN DEBUG ONLY] STACK TRACE:" & vbCrLf & ex.StackTrace
            If ex.InnerException IsNot Nothing Then ErrorMessage &= vbCrLf & vbCrLf & "INNER EXCEPTION: " & vbCrLf & vbCrLf & ex.InnerException.ToString()
            Return ErrorMessage
#Else
            Return ex.Message
#End If
        ...
        ''' <summary>
        ''' Attempts to create a string represention of an object, for debug purposes.
        ''' Under retail, returns an empty string.
        ''' </summary>
...
#End If
        ...
        Public Function ReportWithoutCrash(
                                            ex As Exception,
                                            exceptionEventDescription As String,
                                   Optional throwingComponentName As String = "general"
                                          ) As Boolean
        ...
        ''' <summary> Given an exception, returns True if it is a CheckOut exception. </summary>
        ''' <param name="ex">The exception to check rethrow if it's caused by cancaling checkout</param>
        Public Function IsCheckoutCanceledException(
                                                     ex As Exception
                                                   ) As Boolean

            If (TypeOf ex Is CheckoutException AndAlso ex.Equals(CheckoutException.Canceled)) OrElse
               (TypeOf ex Is COMException AndAlso DirectCast(ex, COMException).ErrorCode = Interop.win.OLE_E_PROMPTSAVECANCELLED) Then
                Return True
            End If
        ...
        ''' <summary> If the given string is Nothing, return "", else return the original string. </summary>
        ''' <param name="Str"/>
        Public Function NothingToEmptyString(
                                              Str As String
                                            ) As String
        ...
        ''' <summary> If the given string is "", return Nothing, else return the original string. </summary>
        ''' <param name="Str"/>
        Public Function EmptyStringToNothing(
                                              Str As String
                                            ) As String
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function GetFullPathTolerant(
                                             Path As String
                                           ) As String
            Try
        ...
        ''' <summary> Given two namespace (either or both of which might be empty), combine them together into a single namespace. </summary>
        ...
        ''' </remarks>
        Public Function CombineNamespaces(
                                           Namespace1 As String,
                                           Namespace2 As String
                                         ) As String
            If Namespace1 = "" Then Return NothingToEmptyString(Namespace2)
            If Namespace2 = "" Then Return Namespace1
            Return Namespace1 & "." & Namespace2
        End Function


        ''' <summary> Given a class name, prepends the given namespace, if any.  If the class given is empty, returns empty. </summary>
        ...
        Public Function AddNamespace(
            ...
            If ClassName = "" Then Return ""  'If class name is missing, then namespace + class name must also be missing.
            If [Namespace] <> "" Then Return [Namespace] & "." & ClassName
        ...
        ''' <remarks></remarks>
        Public Function RemoveRootNamespace(
                                             FullyQualifiedNamespace As String,
                                             RootNamespace As String
                                           ) As String

            Dim RootNamespaceLength As Integer = 0

            If RootNamespace Is Nothing Then RootNamespace = ""

            If FullyQualifiedNamespace Is Nothing Then FullyQualifiedNamespace = ""
        ...
        ''' </returns>
        ''' <remarks></remarks>
        Public Function CreateDialogFilter(
            ...
            For i = 0 To Extensions.Length - 1
                ...
                Filter.Append("*"c & Extension)
            Next

            'Build the programmatic portion
            Filter.Append(")|")
            For i = 0 To Extensions.Length - 1
                If i <> 0 Then Filter.Append(";"c)
                Dim Extension As String = Extensions(i)
                If Extension(0) <> "."c Then Extension = "." & Extension
                Filter.Append("*"c & Extension)
            Next
        ...
        ''' <summary> Returns a localized "All Files (*.*)|*.*" dialog filter string.  Can be used with CombineDialogFilters. </summary>
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function CombineDialogFilters(
                                   ParamArray Filters() As String
                                            ) As String
            Dim CombinedFilter As New StringBuilder

            For Each Filter As String In Filters
                If Filter = "" Then Continue For
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function IIf(Of T)(
                                   Condition As Boolean,
                                   TrueExpression As T,
                                   FalseExpression As T
                                 ) As T
            If Condition Then
        ...
        ''' <remarks></remarks>
        Public Sub SetComboBoxDropdownWidth(
        ...
        ''' </remarks>
        Public Sub SetComboBoxColumnDropdownWidth(
                                                   column As DataGridViewComboBoxColumn
                                                 )
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function MeasureMaxTextWidth(
                                             ctrl As Control,
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Friend Function AppendBackslash(
                                         Path As String
                                       ) As String
            If Path <> "" Then
                Dim r = VB.Right(Path, 1)
                If r <> IO.Path.DirectorySeparatorChar AndAlso r <> IO.Path.AltDirectorySeparatorChar Then Return Path & IO.Path.DirectorySeparatorChar
            End If
            Return Path
        End Function
        ...
        Friend Function GetFilesViaBrowse(
            ...
            Dim uishell = CType(ServiceProvider.GetService(GetType(Microsoft.VisualStudio.Shell.Interop.IVsUIShell)), Microsoft.VisualStudio.Shell.Interop.IVsUIShell)

            Dim fileNames As New ArrayList()

            InitialDirectory = NormalizeInitialDirectory(InitialDirectory)
            If InitialDirectory = "" Then InitialDirectory = Nothing
            ...
            Try
                Dim vsOpenFileName As New Shell.Interop.VSOPENFILENAMEW() With {
                                                                            .lStructSize = CUInt(System.Runtime.InteropServices.Marshal.SizeOf(vsOpenFileName)),
                                                                            ...
                                                                            .nFileExtension = 0,
                                                                            .dwHelpTopic = 0,
                                                                            .dwFlags = CUInt(If(MutiSelect, &H200, 0))
                                                                          }
        ...
        '''<summary> Change the InitialDirectory path to the format we can use in IVsUIShell function. </summary>
        '''<param name="InitialDirectory">The initial directory for the dialog.  Can be Nothing or empty.</param>
        '''<returns>a directory path</returns>
        Private Function NormalizeInitialDirectory(
                                                    InitialDirectory As String
                                                  ) As String
        ...
        ''' <summary> Change the Filter String to the format we can use in IVsUIShell function </summary>
        ''' <param name="Filter">file type filter</param>
        ''' <returns>a native filter string</returns>
        Private Function GetNativeFilter(
                                          Filter As String
                                        ) As String
        ...
        Friend Function GetNewFileNameViaBrowse(
            ...
            Try
                Dim vsSaveFileName As New Shell.Interop.VSSAVEFILENAMEW() With {
                                                                            .lStructSize = CUInt(System.Runtime.InteropServices.Marshal.SizeOf(vsSaveFileName)),
                                                                            .hwndOwner = ParentWindow,
                                                                            .pwzDlgTitle = DialogTitle,
                                                                            ...
                                                                            .dwHelpTopic = 0,
                                                                            .pSaveOpts = Nothing,
                                                                            .dwFlags = CUInt(If(OverwritePrompt, &H2, 0))'&H2 => OFN_OVERWRITEPROMPT
                                                                          }
        ...
        ''' </remarks>
        Friend Function GetRelativePath(
            ...
            If Index = BaseDirectory.Length And Index = Path.Length Then Return "."
        ...
        ''' <summary> Remove the ending separators from a path if it's not a root path. </summary>
        Private Function RemoveEndingSeparator(
                                                Path As String
                                              ) As String
        ...
        ''' <summary> Check whether the screen reader is running. </summary>
        ...
        '''<summary> We use this function to map one color in the image to another color. </summary>
        '''<returns> a new image </returns>
        Friend Function MapBitmapColor(
                                        unmappedBitmap As Image,
            ...
            Try
                ...
                Using g As Graphics = Graphics.FromImage(mappedBitmap)
                    ...
                    Dim colorMap As New ColorMap() With {.OldColor = originalColor, .NewColor = newColor}
        ...
        '''   indeterminate.
        ''' </remarks>
        Public Sub SetCheckboxDeterminateState(
        ...
        ''' <summary> Get the service provider associated with a hierarchy... </summary>
        ''' <param name="pHier"/>
        Public Function ServiceProviderFromHierarchy(
                                                      pHier As Microsoft.VisualStudio.Shell.Interop.IVsHierarchy
                                                    ) As Microsoft.VisualStudio.Shell.ServiceProvider
        ...
        ''' <summary> Sets error code and error message through IVsUIShell interface. </summary>
        ''' <param name="hr">error code</param>
        ''' <param name="errorMessage">error message</param>
        Public Sub SetErrorInfo(
                                 sp As Microsoft.VisualStudio.Shell.ServiceProvider,
                                 hr As Integer,
        ...
        ''' <remarks></remarks>
        Public Function FocusFirstOrLastTabItem(
        ...
        ''' <summary> Validates whether it is a high-surrogate character. </summary>
        ...
        ''' <summary> Validates whether it is a low-surrogate character. </summary>
        ''' <param name="ch">a character to check</param>
        ...
        ''' <summary> Get the namespace for the generated file... </summary>
        ''' <param name="Hierarchy"/>
        ''' <param name="ItemId"/>
        ''' <param name="IncludeRootNamespace"/>
        ''' <param name="SupportCustomToolNamespace"/>
        Friend Function GeneratedCodeNamespace(
                                                Hierarchy As IVsHierarchy,
                                                ItemId As UInteger,
                                                IncludeRootNamespace As Boolean,
                                                SupportCustomToolNamespace As Boolean
                                              ) As String
            ...
            If IsVbProject(Hierarchy) Then
                ...
                If Project IsNot Nothing Then
                    ...
                    End Try
                    If RootNamespaceProperty IsNot Nothing Then RootNamespace = TryCast(RootNamespaceProperty.Value, String)
                End If
            End If
            ...
            If CustomToolNamespace <> "" Then
                If RootNamespace <> "" AndAlso IncludeRootNamespace Then Return String.Concat(RootNamespace, ".", CustomToolNamespace)
        ...
        ''' <return></return>
        ''' <remarks></remarks>
        Private Function IsWCFReferenceValidInProject(
                                                       Hierarchy As IVsHierarchy
                                                     ) As Boolean
        ...
        Friend Function IsServiceReferenceValidInProject(
                                                          Hierarchy As IVsHierarchy
                                                        ) As Boolean
            Return IsWCFReferenceValidInProject(Hierarchy)
        End Function

        ''' <summary> This function check whether Web Reference is supported by default. </summary>
        ''' <param name="Hierarchy"/>
        Friend Function IsWebReferenceSupportedByDefaultInProject(
                                                                   Hierarchy As IVsHierarchy
                                                                 ) As Boolean
            If Hierarchy Is Nothing Then Throw New ArgumentNullException(NameOf(Hierarchy))
        ...
        ''' <summary> Is this a VB project? </summary>
        ''' <param name="Hierarchy"/>
        Friend Function IsVbProject(
                                     Hierarchy As IVsHierarchy
                                   ) As Boolean
            If Hierarchy Is Nothing Then Throw New ArgumentNullException(NameOf(Hierarchy))
        ...
        ''' <summary> Get Framework version number. </summary>
        ''' <param name="Hierarchy"/>
        Friend Function GetProjectTargetFrameworkVersion(
                                                          Hierarchy As IVsHierarchy
                                                        ) As UInteger
        ...
        ''' <summary> Is the current project targeting the Client subset? </summary>
        ''' <param name="Hierarchy"/>
        ''' <returns>True is the current Framework Profile is Client</returns>
        Friend Function IsClientFrameworkSubset(
                                                 Hierarchy As IVsHierarchy
                                               ) As Boolean
            Debug.Assert(Hierarchy IsNot Nothing, NameOf(Hierarchy) & " is required")
...
#Region "SQM data point helpers"
        ...
        Friend Class SQMData
            ...
            ''' </summary>
            ''' <param name="guid"/>
            Friend Shared Function PageGuidToId(
                                                 guid As Guid
                                               ) As Byte
...
#End Region
        ...
        ''' <summary> Determines whether the project associated with the given hierarchy is targeting .NET 4.5 or above. </summary>
        ''' <param name="hierarchy"/>
        Friend Function IsTargetingDotNetFramework45OrAbove(
                                                             hierarchy As IVsHierarchy
                                                           ) As Boolean
        ...
        ''' <summary> Determines whether the given hierarchy is an appcontainer project. </summary>
        ''' <param name="hierarchy"/>
        Friend Function IsAppContainerProject(
                                               hierarchy As IVsHierarchy
                                             ) As Boolean
            ...
            If Not TypeOf propertyValue Is Boolean Then Return False
        ...
        Friend Function IsImplicitlyAddedReference(
                                                    Reference As VSLangProj.Reference
                                                  ) As Boolean

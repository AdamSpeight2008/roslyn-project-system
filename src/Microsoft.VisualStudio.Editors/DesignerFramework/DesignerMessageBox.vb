...
Namespace Microsoft.VisualStudio.Editors.DesignerFramework
    ...
    Friend Class DesignerMessageBox
        ...
        Friend Shared Sub Show(
            ...
            If HelpLink = "" AndAlso ex IsNot Nothing Then HelpLink = ex.HelpLink
        ...
        Private Shared Function ShowHelper(
            ...
            If Caption = "" Then Caption = Nothing 'Causes "Error" to be the caption...
        ...
        '**************************************************************************
        Private Shared Function MessageBoxIconToOleIcon(
                                                         icon As MessageBoxIcon
                                                       ) As OLEMSGICON
            Select Case icon
        ...
        '**************************************************************************
        Private Shared Function EmptyOrSpace(
                                              Str As String
                                            ) As Boolean
